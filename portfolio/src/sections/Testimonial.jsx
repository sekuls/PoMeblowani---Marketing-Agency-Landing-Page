...
const ReviewCard = ({ img, name, username, body }) => {
  return (
    <figure
      className={twMerge(
        "relative h-full w-90 cursor-pointer overflow-hidden rounded-xl border p-4 border-orange-700  bg-amber-700 to-orange-700 hover:bg-orange-500 hover-animation"
      )}
    >
